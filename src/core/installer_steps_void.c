...
void void_copy_xbps_keys(AppData *app, const char *TARGETDIR) {
    ...
    run_sync(app, "wget -O %s/var/db/xbps/keys/3a:23:f2:2d:5e:d1:ab:f5:3f:01:6f:a6:50:9f:15:64.plist https://codeberg.org/javiercplus/Neko-Void/releases/download/repo/key", TARGETDIR);
