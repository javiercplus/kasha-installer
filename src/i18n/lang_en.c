...
static const LangInfo lang_en = {
    ...
    .d_icewm_desc = "Very light, fast and low-resource window manager.",
    .d_i3_desc = "Minimal, tiling window manager for advanced users.",
    .d_jwm_desc = "Ultra-lightweight, retro-style window manager.",
